...
export const NotesEndPoints = {
    ...
    getByPriorityNotes: (parameters: IQueryParametersModel, priority: Priority) => `api/notes/${priority}?PageNumber=${parameters.pageNumber}&PageSize=${parameters.pageSize}`,
