        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2023, 10, 21, 13, 11, 24, 196, DateTimeKind.Utc).AddTicks(8505)),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2023, 10, 21, 13, 11, 24, 196, DateTimeKind.Utc).AddTicks(8755)),
                    user_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
